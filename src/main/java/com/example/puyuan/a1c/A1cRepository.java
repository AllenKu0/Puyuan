...
public interface A1cRepository extends JpaRepository<A1cEntity, Long> {
    ...
    int deleteByIdsAndAppUser(@Param("a1cIds") List<Long> ids, @Param("user") AppUser appUser);
    ...
    int deleteByIdAndAppUser(@Param("a1cId") Long id, @Param("user") AppUser appUser);
}
