...
public interface A1cRepository extends JpaRepository<A1cEntity, Long> {
    ...
    int deleteByIdsAndAppUser(@Param("a1cIds") List<Long> ids, @Param("user") AppUserEntity appUser);
    ...
    int deleteByIdAndAppUser(@Param("a1cId") Long id, @Param("user") AppUserEntity appUser);
}
